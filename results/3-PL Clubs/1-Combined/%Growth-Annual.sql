SELECT 
    ...
    --t0.Club,
    --t0.TotalRevenue,
    SUM(t0.TotalRevenue) AS ' Previous Revenue',
    --t1.TotalRevenue - t0.TotalRevenue,
    SUM(t1.TotalRevenue - t0.TotalRevenue) AS 'Annual Growth Amount',
    FORMAT(ROUND(((SUM(t1.TotalRevenue) - SUM(t0.TotalRevenue)) / SUM(t0.TotalRevenue)) * 100, 2), 'N', 'en-gb') AS 'Annual Growth %'
