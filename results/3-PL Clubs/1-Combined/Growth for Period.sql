SELECT 
    ...
    SUM(t1.TotalRevenue - t0.TotalRevenue) AS [Growth Amount (£m)],
    ...
    FORMAT((ROUND((POWER((SUM(t1.TotalRevenue) / SUM(t0.TotalRevenue)), (1.0 / ((t1.Season - t0.Season)))) - 1) * 100, 2)), 'N', 'en-gb') AS [CAGR (%)]
