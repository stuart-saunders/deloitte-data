...
SELECT
    ...
    FORMAT((ROUND(((SUM(t1.Revenue) / t22.TotalRevenue) * 100), 2)), 'N', 'en-gb') AS [% of 2022 Total],
    SUM(t0.Revenue) AS [2015 Revenue],
    FORMAT((ROUND(((SUM(t0.Revenue) / t15.TotalRevenue) * 100), 2)), 'N', 'en-gb') AS [% of 2015 Total],
